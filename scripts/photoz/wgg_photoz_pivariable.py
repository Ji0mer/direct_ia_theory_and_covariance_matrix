...
def execute(block,config):
    ...
    # because in pk_to_cl_gg the p_k in galaxy power block is divided by blin1 and blin2
    ...
    P_gg_interpolator = interp2d(k_power,chi_power,P_gg,bounds_error=False, fill_value=0)
    ...
    print(block['galaxy_w','w_rp_1_1_%s_%s'%(sample_a,sample_b)])
