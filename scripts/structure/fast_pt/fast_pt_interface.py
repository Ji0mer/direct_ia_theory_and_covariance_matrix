...
def setup(options):
    ...
    fastpt_folder = options.get_string(option_section,"fastpt_folder")
    os.makedirs(fastpt_folder, exist_ok=True)
...
def repeat_execute(block,config):
    if config['do_ia']:
        z = np.load(config['fastpt_folder']+"z.npz")['arr_0']
        k = np.load(config['fastpt_folder']+"k_h.npz")['arr_0']
        Plinfpt = np.load(config['fastpt_folder']+"Plin.npz")['arr_0']
        tt_EE = np.load(config['fastpt_folder']+"P_tt_EE.npz")['arr_0']
        tt_BB = np.load(config['fastpt_folder']+"P_tt_BB.npz")['arr_0']
        ta_dE1 = np.load(config['fastpt_folder']+"P_ta_dE1.npz")['arr_0']
        ta_dE2 = np.load(config['fastpt_folder']+"P_ta_dE2.npz")['arr_0']
        ta_EE = np.load(config['fastpt_folder']+"P_ta_EE.npz")['arr_0']
        ta_BB = np.load(config['fastpt_folder']+"P_ta_BB.npz")['arr_0']
        mix_A = np.load(config['fastpt_folder']+"P_mix_A.npz")['arr_0']
        mix_B = np.load(config['fastpt_folder']+"P_mix_B.npz")['arr_0']
        mix_D_EE = np.load(config['fastpt_folder']+"P_mix_D_EE.npz")['arr_0']
        mix_D_BB = np.load(config['fastpt_folder']+"P_mix_D_BB.npz")['arr_0']
...
#    P=pinterp(k)
    ...
    if config['do_ia']:
        ...
        np.savez(config['fastpt_folder']+"z.npz",z)
        np.savez(config['fastpt_folder']+"k_h.npz",k)
        np.savez(config['fastpt_folder']+"Plin.npz",Plinfpt)
        np.savez(config['fastpt_folder']+"P_tt_EE.npz",tt_EE)
        np.savez(config['fastpt_folder']+"P_tt_BB.npz",tt_BB)
        np.savez(config['fastpt_folder']+"P_ta_dE1.npz",ta_dE1)
        np.savez(config['fastpt_folder']+"P_ta_dE2.npz",ta_dE2)
        np.savez(config['fastpt_folder']+"P_ta_EE.npz",ta_EE)
        np.savez(config['fastpt_folder']+"P_ta_BB.npz",ta_BB)
        np.savez(config['fastpt_folder']+"P_mix_A.npz",mix_A)
        np.savez(config['fastpt_folder']+"P_mix_B.npz",mix_B)
        np.savez(config['fastpt_folder']+"P_mix_D_EE.npz",mix_D_EE)
        np.savez(config['fastpt_folder']+"P_mix_D_BB.npz",mix_D_BB)
        if verbose:
